...
func TestDefaultUpdateHandler(t *testing.T) {
	...
	tests := []struct {
		...
		setup          func() *testPkg.MockStruct // Optional setup function for specific test cases
		expectedStatus int
		expectedBody   string
		overrideBody   bool
	}{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var instance *testPkg.MockStruct
			...
			router.HandleFunc("/mock-struct/{id}", rmHandlers.DefaultUpdateHandler(bed.Src, bed.Db))
